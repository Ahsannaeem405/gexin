        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4">
          <div class="card card1">
            <div class="card-body">
              ...
              <h3 class="card-text">اكسسورات</h3>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4">
          <div class="card card1">
            <div class="card-body">
              ...
              <h3 class="card-text">اضافه الرصيد</h3>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4">
          <div class="card card1">
            <div class="card-body">
              ...
              <h3 class="card-text">اعاده شحن الارصده</h3>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4">
          <div class="card card1">
            <div class="card-body">
              ...
              <h3 class="card-text">بطاقات الالعاب</h3>
            </div>
          </div>
        </div>
      ...
      <div class="row pt-5">
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4">
          <div class="card_div">
            <div class="card card2">
              <div class="card-body">
                <img src="images/googleplay.png" class="card-img-top" alt="...">


              </div>
              <footer class="footer">
                <center>apple card</center>
              </footer>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-12 mt-4">
          <div class="card_div">
            <div class="card card2">
              <div class="card-body">
                <img src="images/nin.png" class="card-img-top" alt="...">

              </div>
              <footer class="footer">
                <center>Pubg Card</center>
              </footer>
            </div>
          </div>
      ...
      <div class="row pt-5">
        ...
        <div class="col-lg-2 col-md-6 col-12 mt-3">
          <div class="card_div">
            <div class="card card2">
              <div class="card-body">
                <img src="images/game5.jpg" class="card-img-top" alt="...">
