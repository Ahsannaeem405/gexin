...
<nav class="navbar navbar-expand-lg sticky-top navbar-light rtl" style="direction:ltr">
    ...
    <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item ">
          <a class="nav-link gm-header" aria-current="page"  href="http://test.gexingold.com/game/checkout/eyJpdiI6IjlOc1VoNHRLaVpxRUlORTUyY0d2XC9RPT0iLCJ2YWx1ZSI6IkIxeGlha1JZSnJnVjVZdUhIRTBBUlE9PSIsIm1hYyI6IjlkYjNmNWIyNTFmZWM5NmVhOWI4YzA3MGNkMmM3NzcyY2ZkOGU0ZWE5MGQ5YThhMzk0Zjg3OWZhMGU3YzAxNDIifQ=="> الرئيسية </a>
        </li>
                                        ...
                                        <div class="col-12">
                                            <div class="currency-item">
                                                ...
                                                <div class="menu-curr-btn">
                                                    <a  href="http://test.gexingold.com/game/checkout/eyJpdiI6IjlOc1VoNHRLaVpxRUlORTUyY0d2XC9RPT0iLCJ2YWx1ZSI6IkIxeGlha1JZSnJnVjVZdUhIRTBBUlE9PSIsIm1hYyI6IjlkYjNmNWIyNTFmZWM5NmVhOWI4YzA3MGNkMmM3NzcyY2ZkOGU0ZWE5MGQ5YThhMzk0Zjg3OWZhMGU3YzAxNDIifQ==" class="reloadBtn">أعاده تعبئه الرصيد</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <ul className="" hidden>
                            <div class="user-menu-inner">
                                ...
                                <div class="profile-dropdown-section">
                                    <a href="inbox.php" class="nav-link-profile nav-link gtm-header-profile pt-1">صندوق الوارد</a>
                                    <!-- <a href="" class="nav-link-profile">عرض ملخص الحساب</a> -->
                                    <a href="transaction.php" class="nav-link-profile nav-link gtm-header-profile pt-1">المعاملات</a>
                                    <a href="account.php" class="nav-link-profile nav-link gtm-header-profile pt-1">ملف تعريفي للمستخدم</a>
                                    <a href="submit-ticket.php" class="nav-link-profile nav-link gtm-header-profile pt-1">قدم التذكرة</a>
                                    <hr>
                                    <a href="login.php" class="nav-link-profile nav-link gtm-header-profile pt-1">خروج</a>
                                </div>
                            </div>
                        </ul>
                    </li>
